...
public class Coopang {
    ...
    public Coopang(String categoryId, String itemTitlePrefix, List<BaseItem> massItemList,
    ...
    public void createExcel() {
        ...
        try {
            FileOutputStream outputStream = new FileOutputStream(CrawlerEcoverde.DIR_POI_FILE + itemTitlePrefix + "_coopang.xlsx");
    ...
    private Object[] createItemRow(BaseItemCosmetic item) {
        ...
        //판매가격
        itemRow[25] = item.getPriceWonString();
        //할인율기준가
        itemRow[26] = 0;
        //재고수량
        itemRow[27] = 10;
